...
},{"axios":"../../node_modules/axios/index.js"}],"items.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editItem = exports.fillForm = exports.deleteItem = exports.createItem = void 0;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            document.querySelector('.img-photo').setAttribute('src', "/img/items/".concat(item.photo));
            _context3.next = 17;
            break;
...
var editItem = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(data, itemId) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            url = "/api/v1/items/".concat(itemId);
            _context4.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  return function editItem(_x4, _x5) {
...
var deleteItemBtn = document.querySelectorAll('.delete-item');
var editItemBtn = document.querySelectorAll('.edit-item');
var formAdd = document.querySelector('.form-add-item');
var formEdit = document.querySelector('.form-edit-item');
...
if (deleteItemBtn) {
  deleteItemBtn.forEach(function (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _items.deleteItem)(button.dataset['id']);
    });
  });
}
...
if (formAdd) {
  formAdd.addEventListener('submit', function (e) {
    ...
    (0, _items.createItem)(form);
  });
}

if (editItemBtn) {
  editItemBtn.forEach(function (button) {
    // console.log(button);
    button.addEventListener('click', function (e) {
      e.preventDefault();
      (0, _items.fillForm)(button.dataset['id']);
    });
  });
}
...
if (formEdit) {
  formEdit.addEventListener('submit', function (e) {
    ...
    formU.append('stock', document.getElementById('stock_u').value); // alert(document.getElementById('photo_u').value);
    ...
    (0, _items.editItem)(formU, document.getElementById('itemId').value);
  });
}
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","bootstrap":"../../node_modules/bootstrap/dist/js/bootstrap.esm.js","./login":"login.js","./items":"items.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
